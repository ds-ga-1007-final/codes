...
def totalFatalities(data):
    ...
    data['NUMBER OF PERSONS INJURED'] + data['NUMBER OF PERSONS KILLED']+\
    ...
    data['NUMBER OF MOTORIST INJURED']+data['NUMBER OF MOTORIST KILLED']  # create a new column that combine all fatalities
    return data
